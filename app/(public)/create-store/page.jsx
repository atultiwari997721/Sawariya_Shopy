    ...
    try {
      ...
      if (["approved", "pending", "rejected"].includes(data.status)) {
        ...
        switch (data.status) {
          case "approved":
            setMessage(
              "Your store is approved and active now. You can start adding products and managing your store."
            );
    ...
    return (
      <div className="min-h-[80vh] flex flex-col items-center justify-center text-slate-400">
        <h1 className="text-2xl sm:text-4xl font-semibold">
          Please <span className="text-slate-800">Login</span> to create a store
        </h1>
      </div>
    );
  }
          ...
          >
            ...
            <div>
              ...
              <p className="max-w-lg">
                To become a seller on Sawariya-Shopy, submit your store details for
