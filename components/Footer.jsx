...
const StudentHubIcon = () => (
  ...
  const linkSections = [
    ...
    },
    {
      title: "WEBSITE?",
      links: [
        { text: <p className="text-green-500 bg-gradient-to-r from-yellow-700 via-yellow-500 to-yellow-800 bg-clip-text text-transparent"><span className="text-green-600">Sawariya-</span><span className="text-green-800">Shopy</span> Student Hub</p>, path: "/student", icon: StudentHubIcon },
  ...
  return (
    <footer className="mx-6 bg-white my-10">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
          <div>
            ...
            <p className="max-w-[410px] mt-6 text-sm">
              Welcome to Sawariya-Shopy, your ultimate destination for the latest and
        ...
        <p className="py-1 text-sm text-slate-600">
          Copyright 2025 © Sawariya-Shopy All Right Reserved.
        </p>
      </div>
    </footer>
  );
